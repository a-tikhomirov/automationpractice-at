...
public class ShoppingCart extends ContentPage {
    ...
    @Step("Check that {itemName} is in the shopping cart")
    public boolean isItemInCart(String itemName) {
        return findElement(CART_ITEMS_LIST, CART_ITEM_NAME, itemName).isDisplayed();
    }

    @Step("Get qty of {itemName} in the shopping cart (for assertion)")
    ...
    @Step("Proceed to the next checkout order step")
    ...
    @Step("Select Agree terms of service checkbox")
    ...
    @Step("Get payment method text (for assertion)")
